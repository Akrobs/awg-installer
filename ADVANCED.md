...
Внутри третьей линии 12 августа 2026 года вышел выпуск `v3.1.20260812`, добавивший ровно два параметра устройства. Наш установщик их не задаёт, но знать про них стоит: один из них при ручном включении рвёт связь с каждым клиентом, у которого он не включён тоже, независимо от версии этого клиента.
...
⚠️ Отсюда практическое: если вы задаёте эти параметры руками, помните, что `KeepaliveTimeout = 20-30` это не опечатка и не интервал «от и до» в смысле таймаута, а именно случайный выбор на каждое применение. Наш установщик ни один из семи не задаёт.
